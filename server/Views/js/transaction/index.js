...
const updateTransData = data => {
    ...
    $("#trans-fee-payer").html(`<a href="/account/${fee_payer_key}">${shorten(fee_payer_key, 10)}</a> <span title="Copy hash to clipboard" data-value="${fee_payer_key}" class="ml-2 mif-copy copy-data-to-clipboard c-pointer"></span>`)
