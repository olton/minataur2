...
const updateDaemonStatus = (data) => {
    ...
    $("#consensus_time_best_tip").html(!status.consensus_time_best_tip ? '' : `epoch: ${Math.floor(status.consensus_time_best_tip.slot_number/status.consensus_time_best_tip.slots_per_epoch)}, slot: ${status.consensus_time_best_tip.slot_number - status.consensus_time_best_tip.slots_per_epoch}`)
    $("#consensus_time_now").html(!status.consensus_time_now ? '' : `epoch: ${Math.floor(status.consensus_time_now.slot_number/status.consensus_time_now.slots_per_epoch)}, slot: ${status.consensus_time_now.slot_number - status.consensus_time_now.slots_per_epoch}`)
